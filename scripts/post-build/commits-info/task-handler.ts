...
const GITHUB_REPO = "cn-ryh/Chemistry-Note-Build";
const AUTHORS_CACHE_URL = `https://mirror.ghproxy.com/https://raw.githubusercontent.com/${GITHUB_REPO}/authors-cache/authors.json`;
